...
const loadUserProfile = async () => {
    ...
    const fillContentForDashboard= ()=>{
        ...
        for (let[type,id] of playlistMap){
            ...
            <section class="featured-songs grid-cols-auto-fill-cards grid gap-4" id="${id}">
    ...
    nowPlayingSongImage.src= 
    "https://i.scdn.co/image/ab67616d0000b273e720e2e8c27f33dfc9f5ee24";
    ...
    for (let trackItem of tracks.items) {
        ...
        track.id = id;
        track.className = "track p-1 grid grid-cols-[50px_1fr_1fr_50px] items-center gap-4 justify-items-start text-secondary rounded-md hover:bg-light-black";
    ...
    `
    // <section class="track grid grid-cols-[50px_1fr_1fr_50px] items-center gap-4 justify-items-start text-secondary rounded-md hover:bg-light-black">
